...
```kotlin
dependencies {
  implementation("com.apollographql.apollo3:apollo-runtime:4.0.12")
}
```
...
dependencies {
  ...
  implementation("com.apollographql.apollo3:apollo-normalized-cache-sqlite:4.0.12")
  // optional: if you just want the generated models and parsers and write your own HTTP code/cache code, you can remove apollo-runtime
  // and use apollo-api instead
  implementation("com.apollographql.apollo3:apollo-api:4.0.12")
}
```
...
```
And then use the `4.0.13-SNAPSHOT` version for the plugin and libraries.
